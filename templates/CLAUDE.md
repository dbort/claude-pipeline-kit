...
<!-- PIPELINE-KIT-SETUP-TODO(project-conventions): fill this section with this repo's language/framework rules, then delete this whole comment block. -->
<!-- Replace with the constraints every implementation and review agent
...
<!-- PIPELINE-KIT-SETUP-TODO(standing-obligations): read this section and confirm you understand entries accrue here over time (it legitimately starts empty), then delete this whole comment block. -->
...
- State current behavior as though it has always been this way; no
  ...
  "used to"). A "(see {TASK_PREFIX}-XXX)" pointer stays only when it
